...
/* harmony import */ var _vendor_tightenco_ziggy__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../vendor/tightenco/ziggy */ "./vendor/tightenco/ziggy/dist/index.esm.js");
...
(0,_inertiajs_vue3__WEBPACK_IMPORTED_MODULE_1__.createInertiaApp)({
  ...
  setup: function setup(_ref) {
    ...
    .use(_vendor_tightenco_ziggy__WEBPACK_IMPORTED_MODULE_3__.ZiggyVue)
...
/* harmony export */   route: () => (/* binding */ F),
/* harmony export */   useRoute: () => (/* binding */ B)
/* harmony export */ });
...
function n(r, n) {
  for (var e = 0; e < n.length; e++) {
    var o = n[e];
    o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(r, t(o.key), o);
  }
}
function e(r, t, e) {
  return t && n(r.prototype, t), e && n(r, e), Object.defineProperty(r, "prototype", {
    writable: !1
  }), r;
}
function o() {
...
function u(r, t) {
  return u = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (r, t) {
...
var a = String.prototype.replace,
  ...
  d = function d(r, t) {
    for (var n = t && t.plainObjects ? Object.create(null) : {}, e = 0; e < r.length; ++e) void 0 !== r[e] && (n[e] = r[e]);
    return n;
  },
  b = {
    arrayToObject: d,
    assign: function assign(r, t) {
      return Object.keys(t).reduce(function (r, n) {
        return r[n] = t[n], r;
      }, r);
    },
    combine: function combine(r, t) {
      return [].concat(r, t);
    },
    compact: function compact(r) {
      for (var t = [{
          obj: {
            o: r
          },
          prop: "o"
        }], n = [], e = 0; e < t.length; ++e) for (var o = t[e], i = o.obj[o.prop], u = Object.keys(i), f = 0; f < u.length; ++f) {
        var a = u[f],
          c = i[a];
    ...
    encode: function encode(r, t, n, e, o) {
      if (0 === r.length) return r;
      var i = r;
      if ("symbol" == _typeof(r) ? i = Symbol.prototype.toString.call(r) : "string" != typeof r && (i = String(r)), "iso-8859-1" === n) return escape(i).replace(/%u[0-9a-f]{4}/gi, function (r) {
    ...
    maybeMap: function maybeMap(r, t) {
      if (p(r)) {
    ...
    merge: function r(t, n, e) {
      ...
      var o = t;
      return p(t) && !p(n) && (o = d(t, e)), p(t) && p(n) ? (n.forEach(function (n, o) {
        if (v.call(t, o)) {
          var i = t[o];
          i && "object" == _typeof(i) && n && "object" == _typeof(n) ? t[o] = r(i, n, e) : t.push(n);
        } else t[o] = n;
  ...
  g = {
    brackets: function brackets(r) {
      return r + "[]";
    },
    comma: "comma",
    indices: function indices(r, t) {
      return r + "[" + t + "]";
    },
    repeat: function repeat(r) {
      return r;
    }
  },
  m = Array.isArray,
  ...
  R = {
    ...
    indices: !1,
    serializeDate: function serializeDate(r) {
      return E.call(r);
    },
    skipNulls: !1,
  ...
  k = function r(t, n, e, o, i, u, f, a, c, l, s, v, p, y) {
    var d,
      h = t;
    if ("function" == typeof f ? h = f(n, h) : h instanceof Date ? h = l(h) : "comma" === e && m(h) && (h = b.maybeMap(h, function (r) {
    ...
    if ("string" == typeof (d = h) || "number" == typeof d || "boolean" == typeof d || "symbol" == _typeof(d) || "bigint" == typeof d || b.isBuffer(h)) {
      if (u) {
        var g = p ? n : u(n, R.encoder, y, "key", s);
        if ("comma" === e && p) {
          for (var w = j.call(String(h), ","), E = "", S = 0; S < w.length; ++S) E += (0 === S ? "" : ",") + v(u(w[S], R.encoder, y, "value", s));
          return [v(g) + "=" + E];
        }
    ...
    for (var N = 0; N < k.length; ++N) {
      ...
      if (!i || null !== A) {
        var D = m(h) ? "function" == typeof e ? e(n, C) : n : n + (c ? "." + C : "[" + C + "]");
        O(T, r(A, D, e, o, i, u, f, a, c, l, s, v, p, y));
      }
    }
    return T;
  },
  ...
  D = function D(r, t, n, e) {
    if (r) {
      ...
      return u && a.push("[" + o.slice(u.index) + "]"), function (r, t, n, e) {
        for (var o = e ? t : A(t, n), i = r.length - 1; i >= 0; --i) {
          var u,
            f = r[i];
  ...
  $ = function $(r, t) {
    var n = function (r) {
      ...
      if (void 0 !== r.charset && "utf-8" !== r.charset && "iso-8859-1" !== r.charset) throw new TypeError("The charset option must be either utf-8, iso-8859-1, or undefined");
      return {
        ...
        interpretNumericEntities: "boolean" == typeof r.interpretNumericEntities ? r.interpretNumericEntities : N.interpretNumericEntities,
    ...
    for (var e = "string" == typeof r ? function (r, t) {
        var n,
          e = {},
          o = (t.ignoreQueryPrefix ? r.replace(/^\?/, "") : r).split(t.delimiter, Infinity === t.parameterLimit ? void 0 : t.parameterLimit),
          i = -1,
          u = t.charset;
        if (t.charsetSentinel) for (n = 0; n < o.length; ++n) 0 === o[n].indexOf("utf8=") && ("utf8=%E2%9C%93" === o[n] ? u = "utf-8" : "utf8=%26%2310003%3B" === o[n] && (u = "iso-8859-1"), i = n, n = o.length);
        for (n = 0; n < o.length; ++n) if (n !== i) {
          var f,
            ...
            l = c.indexOf("]="),
            s = -1 === l ? c.indexOf("=") : l + 1;
          -1 === s ? (f = t.decoder(c, N.decoder, u, "key"), a = t.strictNullHandling ? null : "") : (f = t.decoder(c.slice(0, s), N.decoder, u, "key"), a = b.maybeMap(A(c.slice(s + 1), t), function (r) {
            return t.decoder(r, N.decoder, u, "value");
          })), a && t.interpretNumericEntities && "iso-8859-1" === u && (a = C(a)), c.indexOf("[]=") > -1 && (a = x(a) ? [a] : a), e[f] = T.call(e, f) ? b.combine(e[f], a) : a;
        }
        return e;
      }(r, n) : r, o = n.plainObjects ? Object.create(null) : {}, i = Object.keys(e), u = 0; u < i.length; ++u) {
      var f = i[u],
        a = D(f, e[f], n, "string" == typeof r);
      o = b.merge(o, a, n);
    }
    return b.compact(o);
  },
  I = /*#__PURE__*/function () {
    function r(r, t, n) {
      var e, o;
      this.name = r, this.definition = t, this.bindings = null != (e = t.bindings) ? e : {}, this.wheres = null != (o = t.wheres) ? o : {}, this.config = n;
    }
    var t = r.prototype;
    return t.matchesUrl = function (r) {
      var t = this;
      if (!this.definition.methods.includes("GET")) return !1;
      var n = this.template.replace(/(\/?){([^}?]*)(\??)}/g, function (r, n, e, o) {
          var i,
            u = "(?<" + e + ">" + ((null == (i = t.wheres[e]) ? void 0 : i.replace(/(^\^)|(\$$)/g, "")) || "[^/?]+") + ")";
          return o ? "(" + n + u + ")?" : "" + n + u;
        }).replace(/^\w+:\/\//, ""),
        e = r.replace(/^\w+:\/\//, "").split("?"),
        o = e[0],
      ...
      return this.parameterSegments.length ? this.template.replace(/{([^}?]+)(\??)}/g, function (n, e, o) {
        var i, u;
        if (!o && [null, void 0].includes(r[e])) throw new Error("Ziggy error: '" + e + "' parameter is required for route '" + t.name + "'.");
        if (t.wheres[e] && !new RegExp("^" + (o ? "(" + t.wheres[e] + ")?" : t.wheres[e]) + "$").test(null != (u = r[e]) ? u : "")) throw new Error("Ziggy error: '" + e + "' parameter does not match required format '" + t.wheres[e] + "' for route '" + t.name + "'.");
        return encodeURI(null != (i = r[e]) ? i : "").replace(/%7C/g, "|").replace(/%25/g, "%").replace(/\$/g, "%24");
      ...
      get: function get() {
        var r, t;
        return null != (r = null == (t = this.template.match(/{[^}?]+\??}/g)) ? void 0 : t.map(function (r) {
          return {
            name: r.replace(/{|\??}/g, ""),
            required: !/\?}$/.test(r)
          };
  ...
  Z = /*#__PURE__*/function (r) {
    ...
    function i(t, n, e, i) {
      var u;
      if (void 0 === e && (e = !0), (u = r.call(this) || this).t = null != i ? i : "undefined" != typeof Ziggy ? Ziggy : null == globalThis ? void 0 : globalThis.Ziggy, u.t = o({}, u.t, {
        absolute: e
      }), t) {
        if (!u.t.routes[t]) throw new Error("Ziggy error: route '" + t + "' is not in the route list.");
        u.i = new I(t, u.t.routes[t], u.t), u.u = u.l(n);
      }
      return u;
    }
    ...
    return f.toString = function () {
      var r = this,
        t = Object.keys(this.u).filter(function (t) {
      ...
      return this.i.compile(this.u) + function (r, t) {
        var n,
          e = r,
          o = function (r) {
            if (!r) return R;
            if (null != r.encoder && "function" != typeof r.encoder) throw new TypeError("Encoder has to be a function.");
            ...
            var e = s.formatters[n],
              o = R.filter;
            return ("function" == typeof r.filter || m(r.filter)) && (o = r.filter), {
              ...
              strictNullHandling: "boolean" == typeof r.strictNullHandling ? r.strictNullHandling : R.strictNullHandling
            };
          }(t);
        "function" == typeof o.filter ? e = (0, o.filter)("", e) : m(o.filter) && (n = o.filter);
        var i = [];
        if ("object" != _typeof(e) || null === e) return "";
        var u = g[t && t.arrayFormat in g ? t.arrayFormat : t && "indices" in t ? t.indices ? "indices" : "repeat" : "indices"];
      ...
      var n = {},
        e = Object.entries(this.t.routes).find(function (e) {
          return n = new I(e[0], e[1], t.t).matchesUrl(r);
        }) || [void 0, void 0];
      return o({
        name: e[0]
      }, n, {
      ...
      var r = this.p(),
        t = r.pathname,
        n = r.search;
      return (this.t.absolute ? r.host + t : t.replace(this.t.url.replace(/^\w*:\/\/[^/]+/, ""), "").replace(/^\/+/, "/")) + n;
      ...
      var c = new I(e, f, this.t);
      t = this.l(t, c);
      var l = o({}, i, u);
      return !(!Object.values(t).every(function (r) {
        return !r;
        ...
        return Object.entries(t).every(function (t) {
          var e = t[0],
            o = t[1];
          return Array.isArray(o) && Array.isArray(n[e]) ? o.every(function (r) {
            return n[e].includes(r);
          }) : "object" == _typeof(o) && "object" == _typeof(n[e]) && null !== o && null !== n[e] ? r(o, n[e]) : n[e] == o;
        });
      }(t, l);
    }, f.p = function () {
      var r,
      ...
      var n = this;
      void 0 === r && (r = {}), void 0 === t && (t = this.i), null != r || (r = {}), r = ["string", "number"].includes(_typeof(r)) ? [r] : r;
      var e = t.parameterSegments.filter(function (r) {
        return !n.t.defaults[r.name];
      });
      if (Array.isArray(r)) r = r.reduce(function (r, t, n) {
        var i, u;
        return o({}, r, e[n] ? ((i = {})[e[n].name] = t, i) : "object" == _typeof(t) ? t : ((u = {})[t] = "", u));
      }, {});else if (1 === e.length && !r[e[0].name] && (r.hasOwnProperty(Object.values(t.bindings)[0]) || r.hasOwnProperty("id"))) {
        var i;
        (i = {})[e[0].name] = r, r = i;
      }
      ...
      var t = this;
      return r.parameterSegments.filter(function (r) {
      ...
      return Object.entries(r).reduce(function (r, t) {
        var i,
          ...
          f = t[0],
          a = t[1];
        if (!a || "object" != _typeof(a) || Array.isArray(a) || !e.some(function (r) {
          return r.name === f;
        })) return o({}, r, ((u = {})[f] = a, u));
...
var P = {
  install: function install(r, t) {
    var n = function n(r, _n, e, o) {
      return void 0 === o && (o = t), F(r, _n, e, o);
    };
    parseInt(r.version) > 2 ? (r.config.globalProperties.route = n, r.provide("route", n)) : r.mixin({
      methods: {
        route: n
      }
    });
...
function B(r) {
  if (!r && !globalThis.Ziggy && "undefined" == typeof Ziggy) throw new Error("Ziggy error: missing configuration. Ensure that a `Ziggy` variable is defined globally or pass a config object into the useRoute hook.");
  return function (t, n, e, o) {
    return void 0 === o && (o = r), F(t, n, e, o);
  };
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkprojeto_clinica"] = self["webpackChunkprojeto_clinica"] || [];
